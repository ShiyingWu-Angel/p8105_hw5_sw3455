...
![](p8105_hw5_sw3455_files/figure-gfm/problem2%20plot2-1.png)<!-- -->
...
![](p8105_hw5_sw3455_files/figure-gfm/problem2%20plot2-2.png)<!-- --> On
the plot 2, mean of each 5000 sample mean is really close to their true
mean. Compare to plot 3 for the rejected sample it is significantly more
or less then their true mean as line is not a straight line before 4,
however, after 4, the sample mean are similar to their ture mean and
